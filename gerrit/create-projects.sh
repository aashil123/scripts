...
GERRIT_HOST="aashil123@gerrit.styxproject.tk"
...
GERRIT_PROJECT_PREFIX="StyxProject/"
...
GERRIT_PROJECT_NAMES="$(grep 'styx' .repo/manifests/snippets/styx.xml | awk '{print $3}' | awk -F'"' '{print $2}' | uniq)"
